...
// Explicitly use layout qualifiers for uniform locations
...
layout(location = 4) uniform float uSpeed;
uniform sampler2D uTexture; // Let the system handle texture binding
